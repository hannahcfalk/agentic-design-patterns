...
def info_handler(request: str) -> str:
    ...
    return f"Information request for '{request}' has been simulated."
...
booking_agent = Agent(
    ...
    description="A specialised agent that handles all flight and hotel booking requests by calling the booking tool.",
    tools=[booking_tool],
)
...
async def run_coordinator(runner: InMemoryRunner, request: str):
    ...
    try:
        ...
        # Use run_async instead of run to avoid thread creation
...
async def execute():
    ...
    try:
        ...
        result_d = await run_coordinator(runner, "Find flights in Tokyo next month.")
        ...
        # Properly close the runner and cleanup resources
